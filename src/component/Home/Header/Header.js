        ...
        <nav className='pt-7 pr-3 flex justify-between items-center'>
          ...
          c6,0,8.1-1.7,9.1-5.8h-34.8V23.9z"></path>
                ...
                <ul className='flex justify-center items-center'>
                    <li className='mx-4 font-semibold font-mono'><a className='text-white' href=''>FALCON9</a></li>
                    <li className='mx-4 font-semibold font-mono'><a className='text-white' href=''>FALCON HHEAVY</a></li>
                    <li className='mx-4 font-semibold font-mono'><a className='text-white' href=''>DRAGON</a></li>
                    <li className='mx-4 font-semibold font-mono'><a className='text-white' href=''>HUMAN SPACEFLIGHT </a></li>
                    <li className='mx-4 font-semibold font-mono'><a className='text-white' href=''>RIDESHARE</a></li>
